...
public class JDBCExecutor {
    public static void main(String ... args) {
        ...
        try(Connection connection = localCon.getConnection()){
            ...
            final String GET_ALL = "SELECT * FROM customer";   //1. SELECT ALL records from table Customers.
            ...
            final String SELECT_NAME = "SELECT firstname FROM customer";    //2. SELECT records only from the name column in the Customers table.
            ...
            final String SHOW_CUSTOMER = "SELECT firstname FROM customer WHERE customerid = 1";  //3. Show the name of the Customer whose CustomerID is 1.
...
//            System.out.println("Number of row affected : " + delete);
            ...
            final String SELECT_MAX = "SELECT MAX(amount) FROM payments";   //7. Return the MAXIMUM payment made on the PAYMENTS table.
